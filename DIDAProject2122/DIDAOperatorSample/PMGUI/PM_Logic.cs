...
public delegate void addDebug(string s);

namespace PMGUI {
    public interface IDebugService {
        void AddDebugToGUI(string s);
    }
    public class PM_logic : IDebugService {
        ...
        private readonly FormPM window;
        ...
        public PM_logic(FormPM window) {
            ...
            server = new Server {
                Services = { DIDAPMLogicServerService.BindService(new PMLogicServerService(this)) },
        ...
        public void HandleNextLine(string line) {
            ...
            switch (word) {
                case "scheduler":
                    ...
                    createSchedulerRequest.Debug = debugModeString;
        ...
        */
        ...
        public void AddDebugToGUI(string s) {
            this.window.BeginInvoke(new addDebug(window.AddDebug), new object[] { s });
        }
    ...
    public class PMLogicServerService: DIDAPMLogicServerService.DIDAPMLogicServerServiceBase {

        IDebugService debugService;

        public PMLogicServerService (IDebugService debugService) {
            this.debugService = debugService;
        }

        public override Task<DIDAEmptyDebugReply> RcvDebugMsg(DIDADebugMsg request, ServerCallContext context) {
           
            return Task.FromResult(UpdateDebugUI(request));
        }

        public DIDAEmptyDebugReply UpdateDebugUI(DIDADebugMsg request) {

            debugService.AddDebugToGUI(request.DebugMsg);

            return new DIDAEmptyDebugReply { };
        }
